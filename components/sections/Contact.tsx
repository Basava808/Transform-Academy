          ...
          <div>
            ...
            <div className="space-y-8">
              {LOCATIONS.map((loc) => (
                <div
                  key={loc.id}
                  className="w-full flex items-start space-x-6 border pb-8 pt-4 px-4 rounded-lg transition-all text-left border-gray-200 bg-gray-50 shadow-sm"
                >
          ...
          <div className="bg-gray-50 p-10 border border-gray-200">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-3 mb-2">
                <label className="text-xs text-gray-500 font-bold tracking-widest uppercase">Select Branch</label>
                  ...
                  {LOCATIONS.map((loc) => (
                    <label key={loc.id} className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-black accent-black focus:ring-black border-gray-300"
                      />
                      <span className="ml-2 text-sm text-black font-medium">{loc.name}</span>
                    </label>
                  ))}
                </div>
              </div>
